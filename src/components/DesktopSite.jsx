...
const DesktopSite = () => {
  ...
  return (
    <div style={{
      display: 'flex',
      background: 'linear-gradient(180deg, rgba(55,140,33,1) 0%, rgba(189,189,189,1) 100%)'
    }}>
      <div style={{
        height: '100vh',
        width: '70%',
        ...
        <div style={{
          ...
          {makeHeader && (
            <button
              ...
              type='button'>Get an invite</button>
          )}
        </div>
        <div style={{
          width: '40%',
        ...
        <div
          ...
          <div style={{marginBottom: '10vh',}}>
            <div style={{
              ...
              }}>Do you prefer to scroll timelines – or set your own? Do you think the best place to turn for answers is inward?</span>
              <span
                style={{
                  width: '90%',
                  fontWeight: '800',
                  ...
                  transition: 'opacity 2s',
                  transitionDelay: '1s'
                }}>That’s who this app is For.</span>
            </div>
          </div>
          <div style={{
            marginTop: '20vh',
            ...
            <p style={{
              ...
              marginLeft: '10%',
              textAlign: 'center' 
            }}>Answer open-ended questions to get info on yourself</p>
          </div>
          <div style={{
            marginTop: '20vvh',
            marginBottom: '20vvh',
            ...
            <p style={{
              ...
              marginLeft: '10%',
              textAlign: 'center' 
            }}>Categorize your digital thoughts and form opportunities</p>
          </div>
          <div style={{marginTop: '20vh',}}>
            ...
            <span style={{
              ...
              marginLeft: '10%',
              textAlign: 'center' 
            }}>Turn percieved opportunies into tangible goals you can complete</span>
          </div>
        </div>
        <div style={{
          display: 'flex',
          ...
          <button
            ...
            disabled={gotEmail}
            type='button'>{gotEmail ? 'Submitted' : 'Request Access'}</button>
        </div>
        <div style={{
          width: '100%',
          height: '20vh',
